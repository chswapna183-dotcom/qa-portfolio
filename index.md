...
<!-- TODO: Keep only what you can confidently discuss in interviews. -->

- **Testing Types:** Functional, Smoke, Regression, Exploratory, UAT, Sanity, Retesting
- **Test Design:** BVA, Equivalence Partitioning, Decision Tables, State Transition (basic)
- **Test Documentation:** Test Plan, Test Cases, Checklists, RTM, Test Summary Report
- **Defect Management:** Jira (or similar), clear severity/priority triage, bug lifecycle
- **API Testing:** Postman, Swagger/OpenAPI, cURL (basic), auth flows (JWT/OAuth basics)
- **Web Testing:** Chrome DevTools, cross-browser testing, responsive validation
- **Databases:** SQL basics (SELECT, JOINs), data validation, test data preparation
- **Automation (Optional):** Playwright/Cypress/Selenium, basic framework structure, CI runs
- **Version Control & CI:** Git, GitHub, GitHub Actions (basic), branching & PR reviews
- **Collaboration:** Agile/Scrum ceremonies, Confluence/Notion (docs), Slack/Teams
